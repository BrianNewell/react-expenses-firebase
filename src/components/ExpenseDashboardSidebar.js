...
export const ExpenseDashboardSidebar = () => (

    <nav className="col-md-3 col-lg-2 d-none  d-md-block bg-light sidebar">
        <div className="sidebar-sticky">
            <ul className="nav flex-column mt-2">
                <li className="nav-item">
                    <a className="nav-link active" href="/dashboard" title="Expenses Dashboard">
            ...
            <h6 className="sidebar-heading d-flex justify-content-between align-items-center px-3 mt-4 mb-1 text-muted">
                ...
                <a className="d-flex align-items-center text-muted" href="/" title="Coming soon...">
...
export default ExpenseDashboardSidebar;